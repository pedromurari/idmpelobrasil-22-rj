...
const photos = [
  ...
  { src: novo1, alt: "Participantes do último evento presencial" },
  { src: novo2, alt: "Participantes do último evento presencial" },
  { src: novo3, alt: "Participantes do último evento presencial" },
  { src: novo4, alt: "Participantes do último evento presencial" },
  { src: novo5, alt: "Participantes do último evento presencial" },
  { src: novo6, alt: "Participantes do último evento presencial" },
  { src: novo7, alt: "Participantes do último evento presencial" },
  { src: novo8, alt: "Participantes do último evento presencial" },
  { src: novo9, alt: "Participantes do último evento presencial" },
